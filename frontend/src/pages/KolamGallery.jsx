            ...
            {galleryImages.map((img, idx) => (
              ...
              >
                <img
                  ...
                  src={img}
                />
                <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center cursor-pointer" onClick={handleZoom}>
                </div>
              </div>
            ))}
          </div>
