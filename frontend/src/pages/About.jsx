...
<div 
className="flex min-h-[480px] flex-col gap-6 bg-cover bg-center bg-no-repeat rounded-xl items-center justify-center p-6 text-center shadow-2xl">
<div className="flex flex-col gap-4">
<h1 className="text-white text-4xl sm:text-5xl font-black leading-tight tracking-[-0.033em]">Unveiling the Art of Kolam with AI</h1>
<p className="text-gray-300 text-base sm:text-lg max-w-3xl mx-auto">Explore the rich heritage of Kolam, a traditional South Indian art form, through the lens of artificial intelligence. Our project aims to preserve, understand, and innovate within this beautiful cultural practice.</p>
</div>
