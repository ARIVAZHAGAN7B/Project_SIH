...
const Footer = () => {
  return (
    <footer className="border-t border-solid border-t-[#242447]">
...
<p className="text-gray-400 text-sm">© 2024 Kolam AI. All rights reserved.</p>
</div>
</div>
</footer>
  )
